...
class Assessment(object):
    ...
    def display_result(self):
        ...
        '''
        # CH to glue together strings use +, not ,
        # your version is just a lazy way of creating a tuple:
        ...
        # Suggestion: set up a dict that associates the text with a score
        ...
        # make correct text
        grid_as_word = grit_words[grit_level]

        score_msg = f"You scored a {result} which means you have {grid_as_word} grit."
        ...
        with open("results.csv", "w+") as fo:
            for i in range(0, self.data_size): # loop over all statements
                ...
                possible_responses = self.responses[i]
                ...
                print(f"{i},{statement},{response_text}", file=fo) # format with commas and write to file
